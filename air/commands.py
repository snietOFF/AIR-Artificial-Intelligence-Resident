...
from air import models, prompts, voice
from air.editor import pipe_editor
from air.format_settings import format_settings
from air.help import Help, install_help_extra
from air.io import CommandCompletionException
from air.llm import litellm
from air.repo import ANY_GIT_ERROR
from air.run_cmd import run_cmd
from air.scrape import Scraper, install_playwright
from air.utils import is_image_file
...
class Commands:
    ...
    def cmd_chat_mode(self, args):
        ...
        show_formats = OrderedDict(
            [
                ("help", "Get help about using air (usage, config, troubleshoot)."),
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by air"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.air_commit_hashes:
            self.io.tool_error("The last commit was not made by air in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so air can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to airignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use air.")

    def cmd_help(self, args):
        "Ask questions about air"
        ...
        from air.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of air was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from air.report import report_github_issue
