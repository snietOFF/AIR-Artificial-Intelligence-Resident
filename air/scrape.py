...
from air import __version__, urls, utils
from air.dump import dump  # noqa: F401

air_user_agent = f"Air/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["air-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({air_user_agent})"}
        try:
            with httpx.Client(
